...
---
```{r}
# 1. 5x5 matrix on vectorA = [1,2,3,4,5] and a 5x5 zero matrix
vectorA <- c(1, 2, 3, 4, 5)
...
```{r}
# 6.e Scatterplot of sepal length vs. sepal width by species
...
```{r}
# 6.f
#The scatterplot shows that each species has different sepal sizes. Setosa has short, wide sepals, while Virginica and Versicolor have long, narrow ones. This helps in identifying each species.
```

```{r}
# 7.a Cleaning and renaming variants in the Alexa data
library(readxl)
